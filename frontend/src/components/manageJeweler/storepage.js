...
const StorePage = () => {
  ...
  const [rejectedno, setRejectedno] = useState(0);
  ...
  const fetchStats = async () => {
    try {
      const notify = await getJewelerNotifications();
      const unread = notify.filter(
        (notification) => notification.status === "unread"
      );
      setNotificationno(unread.length);
      ...
      <div className="alluse text-stone-200 lg:flex lg:flex-wrap justify-center">
        <div className="lg:w-2/6 p-6 bg-neutral-900 rounded-lg order-2 md:order-1 mb-8 ">
          ...
          <div
            ...
            className="cursor-pointer mt-8 flex justify-center w-[100%] alluse inline-block rounded bg-yellow-600 pb-2.5 pt-3 text-base font-semibold leading-normal text-white hover:text-white  transition duration-150 ease-in-out hover:bg-yellow-600 hover:shadow-[0_8px_9px_-4px_rgba(202,138,4,0.3),0_4px_18px_0_rgba(202,138,4,0.2)] focus:bg-yellow-600 focus:shadow-[0_8px_9px_-4px_rgba(202,138,4,0.3),0_4px_18px_0_rgba(202,138,4,0.2)] focus:outline-none focus:ring-0 active:bg-yellow-600"
          >
          ...
          <p
            className="text-stone-200 pt-5 text-center allusebody cursor-pointer duration-300 hover:text-yellow-600 hover:scale-110"
          ...
          <h1 className="alluse pt-8 text-3xl text-center text-stone-200 pb-4">
            Jeweler Profile
          </h1>
          ...
          <Link
            to={`/editjewelerprofile`}
            className="mt-8 flex justify-center w-[100%] alluse inline-block rounded bg-yellow-600 pb-2.5 pt-3 text-base font-semibold leading-normal text-white hover:text-white  transition duration-150 ease-in-out hover:bg-yellow-600 hover:shadow-[0_8px_9px_-4px_rgba(202,138,4,0.3),0_4px_18px_0_rgba(202,138,4,0.2)] focus:bg-yellow-600 focus:shadow-[0_8px_9px_-4px_rgba(202,138,4,0.3),0_4px_18px_0_rgba(202,138,4,0.2)] focus:outline-none focus:ring-0 active:bg-yellow-600"
          >
        ...
        <div className="lg:w-4/6 pl-5 pr-5 pt-3 pb-5  text-center md:text-left order-1 md:order-2">
          <div className="flex justify-between align-start ">
            <p className="text-[40px] alluse text-left my-auto">
              {jeweler.storename}
            </p>
            <p className="my-auto">
              {!anchorEl ? (
                <span onClick={handleClick}>
                  <Bars3Icon
                    className="h-10 w-10 cursor-pointer my-auto"
                    strokeWidth={2}
                  />
                </span>
              ) : (
          ...
          <p className=" text-2xl allusebody pt-6">
            Welcome to your personalised{" "}
            <span className="text-yellow-600">Jeweler Store</span>
          </p>
          ...
          <div className="rounded-lg mt-4 alluse">
            <div className="md:grid md:grid-flow-col justify-stretch align-center text-xl text-stone font-semibold">
              <div
                onClick={() => {
                  navigate("/jeweler-notifications");
                }}
                className="custom-shadow cursor-pointer bg-zinc-800 rounded-lg mt-5 m-3 p-3 hover:bg-yellow-600 hover:scale-105 duration-300"
              >
                <div className="flex">
                  <img
                    className="w-6 h-6"
          ...
          <div className="bg-neutral-900 m-2 p-3 rounded-lg duration-300 mt-8">
            ...
            <p className="allusebody pt-3 text-lg text-justify">
              Discover your virtual storefront at{" "}
              <span className="text-yellow-600">EGold Haven</span>, where you
              can effortlessly manage your gold jewelry collection. Easily add
              new products, update existing listings, and showcase your
            ...
            <div className="grid grid-flow-col justify-stretch pt-5">
              <div className="text-center pr-5 pl-5">
                <p className="text-stone-200 text-lg border-b allusebody pb-1">
                  Pending Approval
                </p>
              ...
              <div className="text-center pl-5 pr-5">
                ...
                <p className="text-center text-xl m-1">{rejectedno}</p>
              </div>
            </div>
