    ...
    return (
        <div className='p-5'>
            ...
            <form className='p-10 m-5  rounded-lg bg-neutral-900'>
                ...
                <Select showSearch placeholder="Select the city" optionFilterProp="children"
                        filterOption={true} style={{ width: '100%', height: 40, marginBottom: 20 }} onChange={handleLocationChange}    
                >
                     {options.map((option) => (
