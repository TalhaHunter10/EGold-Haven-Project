        ...
        <div className='p-5'>
            ...
            <div className="flex flex-wrap m-5">
                ...
                <div className="w-[100%] lg:w-2/3 p-4">
                    ...
                    <h1 className='alluse text-4xl text-stone-200 pb-5 min-[200px]:text-center sm:text-left'>Product Details</h1>
                ...
                <div className="w-[100%] lg:w-1/3 bg-neutral-900 p-8 rounded-lg">
                    <div className=''>
                        <h1 className='alluse text-4xl text-center text-stone-200 pb-6'>Jeweler</h1>
                        ...
                        <p className='alluse tracking-widest pt-2 alluse text-sm pl-16 text-stone-200 my-auto'>
                            <span className='font-semibold'> Registered Since: </span> {jeweler && jeweler.createdAt && new Date(jeweler.createdAt).toLocaleDateString()}
                        </p>
            ...
            <h1 className='headingtextlanding text-stone-200 pt-5 pl-8'>Similar Products</h1>
            ...
            <div className='categories flex flex-wrap lg:justify-center md:justify-start pt-5 pb-5  '>
                {similarproduct.length === 0 ? (
                    isSimilarLoading ? (
                        ...
                        <p className='text-stone-200 text-center pl-8 text-2xl'>No similar products found !</p>
                    )
                ) : (
                    <div className="">
