...
const ContainerProductAll = ({ product }) => {



    return (
        <div className="pl-2 pr-2 containertext cursor-pointer mt-1 pb-5 pt-5 flex  flex-wrap min-[150px]:justify-center md:justify-start">
            {product.map((item) => (
...
export default ContainerProductAll;