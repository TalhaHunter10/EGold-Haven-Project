    ...
    <>
      {notificationsCount > 0 && (
        <Badge
          ...
          color="yellow"
          className="ml-8 py-1 px-1.5 bg-yellow-700 rounded-full"
        />
      )}
      <Link to="/user-notifications">
        <img
          ...
          alt="Notification"
          className="user-icon notification-icon ml-5 w-7 cursor-pointer"
        />
      </Link>
    </>
  );
...
const Header = () => {
  ...
  return (
    <header className="header">
      <Link to="/">
        <img
          src="/images/EGHLogo.png"
          alt="logo"
          className="weblogo  md:h-22.5 md:w-64 cursor-pointer"
        ></img>
      </Link>
      ...
      <div className="nav-container">
        ...
        {isLoggedIn ? (
          <div className="user-icons">
            ...
            <span className="user-icon flex items-center ml-5 md:ml-0">
              <img
                ...
                alt="User"
                className="ml-5 w-10 cursor-pointer"
                onClick={handleClick}
              />
              <img
                src="/images/arrowdownicon.png"
                alt="arrowdown"
                className="arrowdown-icon w-2 cursor-pointer"
                onClick={handleClick}
              />
            </span>
          </div>
          ...
          <Link to="/login">
            <button className="nav-button ml-5 text-lg">Login</button>
          </Link>
        )}
      </div>
