...
const ContainerAll = ({ listing }) => {

    return (
        <div className="pl-2 pr-2 containertext cursor-pointer mt-1 pb-10 pt-5 flex flex-wrap min-[150px]:justify-center md:justify-start">
            {listing.map((item) => (
